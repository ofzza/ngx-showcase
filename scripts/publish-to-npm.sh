...
libVersion=$( cat ../dist/ngx-showcase/package.json | jq -r ".version");
...
libAuthor=$( cat ../dist/ngx-showcase/package.json | jq -r ".author");
...
libTitle=$( cat ../dist/ngx-showcase/package.json | jq -r ".title");
...
libDescription=$( cat ../dist/ngx-showcase/package.json | jq -r ".description");
